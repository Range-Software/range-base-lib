...
void RRMatrix::invert()
{
    ...
    if (n == 0)
    {
        throw RError(RError::Type::Application,R_ERROR_REF,"Can not invert zero sized matrix.");
    }
    else if (n == 1)
    {
        if (this->getValue(0,0) == 0.0)
        {
            throw RError(RError::Type::Application,R_ERROR_REF,"Can not invert zero value matrix.");
        }
    ...
    else if (n == 2)
    {
        ...
        if (det == 0.0)
        {
            throw RError(RError::Type::Application,R_ERROR_REF,"Can not invert matrix. Matrix determinant = 0");
        }
    ...
    else if (n == 3)
    {
        ...
        if (det == 0.0)
        {
            throw RError(RError::Type::Application,R_ERROR_REF,"Can not invert matrix. Singular matrix.");
        }
...
//        if (big == 0.0)
//        {
//            throw RError(RError::Type::Application,"LU decomposition failed. Singular matrix.");
//        }
...
double RRMatrix::norm(const RRMatrix &M)
{
    ...
    return RRVector::euclideanNorm(v);
} /* RRMatrix::norm */
...
double RRMatrix::norm(const RRMatrix &M, const RRVector &b)
{
    ...
    double norm1 = RRVector::euclideanNorm(v);
    double norm2 = RRVector::euclideanNorm(b);
