...
typedef void (*RProgressInitializeHandler)(const QString &message, bool pulseType);
...
class RProgress
{
    ...
    public:
        ...
        RProgressPrintHandler getProgressPrintHandler() const;
        ...
        RProgressInitializeHandler getProgressInitializeHandler() const;
        ...
        RProgressFinalizeHandler getProgressFinalizeHandler() const;
        ...
        void initialize(const QString &message, bool pulseType = false);
...
void RProgressInitialize(const QString &message, bool pulseType = false);
