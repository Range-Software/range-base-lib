...
class RPlane
{
    ...
    public:
        ...
        RPlane(const RR3Vector &position, const RR3Vector &normal);

        //! Constructor (from triangle).
        RPlane(const RR3Vector &node1, const RR3Vector &node2, const RR3Vector &node3);
        ...
        const RR3Vector & getNormal() const;
