...
class RR3Vector : public RRVector
{
    ...
    public:
        ...
        static void cross(const RR3Vector &v1, const RR3Vector &v2, RR3Vector &vp);

        //! Check if vectors are parallel and return number of parallel dimensions.
        static bool areParallel(const RR3Vector &v1, const RR3Vector &v2);

        //! Angle between two vectors (in radians).
        static double angle(const RR3Vector &v1, const RR3Vector &v2);
